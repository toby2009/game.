...
zj5:
                    SlowDisplay("第六章 智取夜光珠\n");
                    SlowDisplay("整个事情太疯狂了，你们被竹子国的人抓了之后，你们知道的就是，你们被戴上了枷锁，投入了地牢。。。与此同时暗黑诅咒8天后显灵。。。\n");
...
zj9:
    ...
    printf("制作：drzo   校正：drzo,haobo8   编剧：drzo   模仿游戏：《传说之下》    特别鸣谢：洛谷，LiiDP，别的网站刷题，haobo8，shiys2017，issac_kong，不死就作君\n");
    system("pause");
     SlowDisplay("以下为彩蛋：\n");
...
return 0;
                ...
                SlowDisplay("你们回到了ZO村来庆祝胜利，你得了好多奖赏，你血又变回100000了。\n");
                m.blood=100000;
                SlowDisplay("突然，Pavris走了过来，他说：刚刚我回了家，发现。。。公主死了。。。是你干的吗。。。      你：。。。\n");
                SlowDisplay("Pavris：为什么。。。为什么！！！    你：。。。\n");
                SlowDisplay("Pavris：要知道爱是一个强大的东西，你彻底激怒了我。。。\n");
                cout<<"下";
                 Sleep(750);
                cout<<"地";
                 Sleep(750);
                ...
                cout<<"吧！！！"<<endl;
                 Sleep(750);
                    texiao();
                SlowDisplay("Pavris朝你扑了过来！！！QAQ\n");
                     texiao();
                     int c2=3,c3=10,c4=5,c5=1;
                      while(m.blood>=0)
                      {
                        cout<<"你有5个绝招：1.鬼火（能使无限次，攻击为"<<a1<<"） 2.冰封（能使3次，让敌方速度减"<<a2<<"） 3.霹雳（使10次，攻击为"<<a3<<"） 4.万物复苏（使5次，血+"<<a4<<"） 5.天崩地裂（1次，攻击"<<a5<<"，涨血"<<a6<<"）"<<endl;
                    cout<<"敌方的血还有1000000"<<endl;
                    cout<<"你的血还有"<<m.blood<<"   请攻击（选择绝招编号）"<<endl;
                    int z;
                    ...
                    m.blood =1;
                    SlowDisplay("你还有丝儿血，1滴血，你要不行了！！！QAQ\n");
                    SlowDisplay("这时，只见天空中飞来一道光，正中Pavris。。。\n");
                    SlowDisplay("你还有丝儿血，1滴血，你要不行了！！！QAQ\n");
                    SlowDisplay("Pavris血-99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n");

                    SlowDisplay("Pavris：哥哥，");
                cout<<"我";
                 Sleep(750);
                cout<<"来";
                 Sleep(750);
                ...
                cout<<"。。。"<<endl;
                 ...
                 system("pause");
                 system("cls"); 
                    SlowDisplay("病毒正在侵入游戏。。。\n");

                 system("pause");
                    SlowDisplay("这时，打开声音，体验更好。。。\n");
                 int pai=500,ban=250;
int ting=128;
...
Sleep(1000);
                        ...
                        SlowDisplay("什么？？！！洗脑洗的不够？？！！\n");
                        SlowDisplay("好吧，那就再来一个。。。\n");
                        system("pause");
                        for(int i=0; i<100000; i++)
                        {
                            cout<<"ui董景安大师帮我i前几年第五部分贵哦亲当年我把我的可能被发给我会经常南北文化妇女和端口扫描那部分文化节开幕当晚妇女的承诺王菲哦否认他一会给你发出版南非几点开门内含物欸牵牛紧哦碰肉体九年";

                         } 
                         system("pause");
                        SlowDisplay("不错，你还活着。。。没关掉游戏。。。\n");
                        SlowDisplay("你好，我是开挂玩家haobo8，很高兴见到你。。。你很强大，我看出来了，一般能到黑化结局的人都是心狠手辣的人，而我正需要这样的人，来打败drzo游戏控制者，改变整个游戏，控制整个游戏，哈哈哈哈哈哈哈哈哈哈哈哈！！！\n");
                        SlowDisplay("你是否要帮助我： 1.是  2.否\n");
                        int haobo;
                        cin>>haobo;
                        if(haobo==1)
                        {
