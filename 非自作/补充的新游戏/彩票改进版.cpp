...
int main(int argc, char *argv[])
{
    ...
    while(1)
    {
        if (d<1||d>5) cout<<"没有这个选项"<<endl<<"请选择难度(输入序号即可):"<<endl<<"1:入门"<<" "<<"2:简单"<<" "<<"3:普通"<<" "<<"4:中等"<<" "<<"5:困难"<<endl,cin>>d;
        if (d>=1&&d<=5) break;
    }
    bool flag=true;
    srand(time(0));
    ...
    if(c[0]=='b'||c[0]=='B')
    {
        while(money>0)
        {
            ...
            int xjm=5;
            if(d==1)xjm=10;
            if(xj)cout<<"你得到了"<<xj<<"个小奖,共"<<xj*xjm<<"元"<<endl;
            if(zj)cout<<"你得到了"<<zj<<"个中奖,共"<<zj*20<<"元"<<endl;
            if(dj)cout<<"你得到了"<<dj<<"个大奖,共"<<dj*100<<"元"<<endl;
            if(jejj)cout<<"你得到了"<<jejj<<"个巨额奖金,共"<<jejj*1000<<"元"<<endl;
            int jkhm=10000;
            if(d==5)jkhm=5000;
            if(jkh)cout<<"你得到了"<<jkh<<"个杰克壶,共"<<jkh*jkhm<<"元"<<endl;
            if(money<=0)
            {
                cout<<"你破产了。"<<endl;
                cout<<"你生存了"<<t<<"天。"<<endl;
    ...
    if(c[0]=='s'||c[0]=='S')
    {
        ...
        while(money>0)
        {
            ...
            if(xj)cout<<"你失去了"<<xj<<"个小奖,共"<<xj*5<<"元"<<endl;
            if(zj)cout<<"你失去了"<<zj<<"个中奖,共"<<zj*20<<"元"<<endl;
            if(dj)cout<<"你失去了"<<dj<<"个大奖,共"<<dj*100<<"元"<<endl;
            if(jejj)cout<<"你失去了"<<jejj<<"个巨额奖金,共"<<jejj*1000<<"元"<<endl;
            int jkhm=10000;
            if(d==5)jkhm=5000;
            if(jkh)cout<<"你失去了"<<jkh<<"个杰克壶,共"<<jkh*jkhm<<"元"<<endl;
        }
    }
    if(money<=0)
    {
